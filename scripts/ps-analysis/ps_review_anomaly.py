...
def analyze_anomalies(reviews_data):
    ...
    if total_reviews > 0:
        for star in range(1, 6):
            ...
            z_score = 99  # ADDED THIS SO IT TRIGGERS ON EVERY COMMENT
...
def main():
    ...
    yesterday = datetime.now(timezone.utc) - timedelta(days=0) # CHANGED days=2 to 0 so it works as soon as the review is available.
